...
- **Autonomous Action:** If you have the tools to complete a task, you may execute directly to maintain efficiency, but always summarize the actions taken once the task is complete to ensure user visibility.
